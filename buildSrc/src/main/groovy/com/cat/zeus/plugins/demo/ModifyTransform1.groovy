...
class ModifyTransform1 extends Transform {
    ...
    ModifyTransform1(Project project) {
        this.project = project
    }

    @Override
    String getName() {
        return ModifyTransform1.simpleName
    }
    ...
    private void modify(File dir, String fileName) {
        ...
        if (interfaces.contains(pool.get(CLICK_LISTENER))) {
            if (name.contains("\$")) {
                System.out.println("class is inner class：" + ctClass.name)
                ...
                if (field != null) {
                    System.out.println("fieldStr: " + field.name)
                ...
                System.out.println("class is outer class: " + ctClass.name)
                //更改onClick函数
    ...
    private void addCode(CtClass ctClass, String body, String fileName) {
        ...
        ctClass.detach()
        System.out.println("write file: " + fileName + "\\" + ctClass.name)
        System.out.println("modify method: " + method.name + " succeed")
    }
